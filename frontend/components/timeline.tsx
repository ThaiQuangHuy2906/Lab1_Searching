...
export function Timeline() {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 items-center gap-3 rounded-lg border border-surface-border bg-surface-panel/95 px-4 py-2.5">
