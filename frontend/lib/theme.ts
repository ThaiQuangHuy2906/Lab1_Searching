...
export const THEME_OPTIONS: readonly ThemeOption[] = [
  {
    value: "default",
    label: "Mặc định",
    description: "Control room cyan, tím và amber",
    appearance: "dark",
  ...
  },
  {
    value: "pink",
    label: "Hồng baby",
    description: "Hồng phấn phối xanh baby",
    appearance: "light",
  ...
  },
  {
    value: "lavender",
    label: "Lavender",
    description: "Tím lavender phối hồng berry",
    appearance: "light",
  ...
  },
  {
    value: "sage",
    label: "Sage & kem",
    description: "Xanh sage, kem và hồng chỉ",
    appearance: "light",
