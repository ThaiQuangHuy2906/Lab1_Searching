...
> `cd backend && ../.venv/Scripts/python.exe -m app.benchmark`
> Sau đó: `python scripts/gen_teaching_doc.py` + đồng bộ số theo Phụ lục A
> của `docs/KIEMTOAN.md`. Hiệu chuẩn γ từ TomTom: `python scripts/05_calibrate_gamma.py`
> → `results/gamma_calibration.csv`.

| File | Thí nghiệm |
|---|---|
| exp1_correctness.csv | Đối chứng 10 thuật toán vs NetworkX (1 200 ca) |
